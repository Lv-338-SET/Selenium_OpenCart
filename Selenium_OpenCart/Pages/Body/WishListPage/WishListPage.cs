...
namespace Selenium_OpenCart.Pages.Body.WishListPage
{
    public class WishListPage
    {
        ...
        protected IWebElement TableRow { get { System.Threading.Thread.Sleep(450); return Application.Get().Search.ElementByXPath("//div[@class='table-responsive']//tbody"); } }
        protected WishListTableItem product { get { System.Threading.Thread.Sleep(450); return GetProductElement(GetTableRow()); } }
